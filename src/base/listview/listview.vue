<template>
  <scroll class="listview"
    ...
    <div class="list-shortcut" @touchstart="onShortcutTouchStart" @touchmove.prevent="onShortcutTouchMove">
      <ul>
  ...
  export default {
    ...
    methods: {
      ...
      onShortcutTouchStart(e) {
        ...
        let firstTouch = e.touches[0]//事件中
      ...
      onShortcutTouchMove(e) {
        ...
        let anchorIndex = parseInt(anchorIndex) + delta
        this._scrollTo(anchorIndex)
      },
      refresh(){
